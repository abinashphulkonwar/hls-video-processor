...
var queue = new bullmq_1.Queue("video-prossing", {
    connection: {
...
var every = 1000 * 5;
queue
    .add("hls", { qux: "idvhjvjhbjhbhj", id: "id" }, {
    ...
    .then(function () { return queue.disconnect(); });
...
client
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.publish("video-prossing", JSON.stringify({
